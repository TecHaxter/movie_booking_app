...
void setupLocator() {
  locator.registerFactory<UpcomingMoviesBloc>(
    () => UpcomingMoviesBloc(locator.get<FetchUpcomingMoviesUsecase>()),
  );

  locator.registerFactory<MovieDetailsBloc>(
    () => MovieDetailsBloc(locator.get<FetchMovieDetailsUsecase>()),
  );

  locator.registerFactory<CinemasBloc>(
      () => CinemasBloc(locator.get<FetchCinemasByMovieUsecase>()));
  ...
  locator.registerLazySingleton<MoviesRepository>(
    () => MoviesRepositoryImpl(locator.get<MoviesDataSource>()),
  );
  ...
  locator.registerLazySingleton<FetchMovieDetailsUsecase>(
    () => FetchMovieDetailsUsecaseImpl(locator.get<MoviesRepository>()),
  );

  locator.registerLazySingleton<FetchUpcomingMoviesUsecase>(
    () => FetchUpcomingMoviesUsecaseImpl(locator.get<MoviesRepository>()),
  );

  locator.registerLazySingleton<FetchCinemasByMovieUsecase>(
    () => FetchCinemasByMovieUsecaseImpl(locator.get<CinemaRepository>()),
  );
